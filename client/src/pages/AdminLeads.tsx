import { Download, Filter, Mail, RefreshCw, Users } from "lucide-react";
...
export default function AdminLeads() {
  ...
  const exportCsv = () => {
    ...
    const header = ["Data", "Nome", "Empresa", "E-mail", "Porte", "Assunto", "Origem"];
    const content = [header, ...rows.map((lead) => [new Date(lead.createdAt).toLocaleString("pt-BR"), lead.name, lead.company, lead.email, lead.companySize, lead.challenge, lead.source])]
