/* Cenvara lead layer: qualification stays local until explicit consent and ends with concise, accessible success feedback. */
...
export function LeadQualificationForm() {
  ...
  return <form className="lead-form" onSubmit={handleSubmit}>
    ...
    <label className="lgpd-consent"><input type="checkbox" checked={form.consent} onChange={(event) => update("consent", event.target.checked)} required /><span>Autorizo a Cenvara a usar estes dados exclusivamente para responder ao meu pedido e iniciar o atendimento pelo WhatsApp. Consulte a <a href="/politica-de-privacidade">Política de Privacidade</a>.</span></label>
