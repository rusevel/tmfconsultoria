...
Assunto principal: ${form.challenge}`;
  ...
  return <form className="lead-form" onSubmit={handleSubmit} noValidate>
    ...
    <button type="submit" className="lead-submit"><Check size={17} /> Enviar e abrir WhatsApp <ArrowUpRight size={16} /></button>
    {submitted && <div ref={successRef} className="form-success" role="status" aria-live="polite" tabIndex={-1}><span className="form-success-icon"><Check size={17} /></span><div><strong>Contato preparado.</strong><small>Seus dados foram validados, os campos foram limpos e a mensagem com o assunto escolhido foi aberta no WhatsApp.</small></div><span className="form-success-step">01 / 01</span></div>}
  </form>;
}
