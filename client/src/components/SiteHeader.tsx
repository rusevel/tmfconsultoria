...
export function SiteHeader({ contactMessage, home = false }: SiteHeaderProps) {
  ...
  const links = home
    ? [{ href: "#solucoes", label: "Áreas de atuação" }, { href: "#processo", label: "Método" }, { href: "#essencia", label: "Essência" }, { href: "#blog", label: "Artigos" }, { href: "/sobre-a-cenvara", label: "Sobre" }, { href: "/casos-de-sucesso", label: "Casos" }, { href: "/apresentacao", label: "Apresentação" }]
    : [{ href: "/#solucoes", label: "Áreas de atuação" }, { href: "/#processo", label: "Método" }, { href: "/blog", label: "Artigos" }, { href: "/sobre-a-cenvara", label: "Sobre" }, { href: "/casos-de-sucesso", label: "Casos" }, { href: "/apresentacao", label: "Apresentação" }, { href: "/#duvidas", label: "Dúvidas" }];
