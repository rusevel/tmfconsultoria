...
export function SiteHeader({ contactMessage, home = false }: SiteHeaderProps) {
  ...
  const links = home
    ? [{ href: "#solucoes", label: "Áreas de atuação" }, { href: "#processo", label: "Método" }, { href: "#essencia", label: "Essência" }, { href: "#duvidas", label: "Dúvidas" }]
    : [{ href: "/#solucoes", label: "Áreas de atuação" }, { href: "/#processo", label: "Método" }, { href: "/#duvidas", label: "Dúvidas" }];
