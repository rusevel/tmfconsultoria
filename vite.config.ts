  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        instagram: path.resolve(import.meta.dirname, "client", "instagram", "index.html"),
        artigoMudancasFiscais: path.resolve(import.meta.dirname, "client", "blog", "mudancas-fiscais-decisoes-seguras", "index.html"),
        artigoFerramentasDigitais: path.resolve(import.meta.dirname, "client", "blog", "ferramentas-digitais-operacao", "index.html"),
        artigoCrescimentoEstruturado: path.resolve(import.meta.dirname, "client", "blog", "crescimento-com-estrutura", "index.html"),
      },
    },
  },
  server: {
